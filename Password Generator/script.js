...
async function copyContent() {
    ...
    // to make copied text visible using css
...
function handleCheckBoxChange() {
    ...
    // edge case-(this below code handle if passwordlegth(slider) is < no. of checked boxes then passwordlength = checkcount)
...
generateBtn.addEventListener('click',() => {
    ...
    // start the generating password from empty. 
    password = "";
